...
-- Anonymous public AI chat. Browser cookies contain an unguessable token;
-- only its SHA-256 hash is stored here. No raw IP address or visitor identity is saved.
